...
// $droit_public,$droit_prive,$droit_affaires si 1 alors c'est coché validé, si 0 c'est que le client à dit non.
 public function inserer_email_newsletter($email, $droit_public, $droit_prive, $droit_affaires)
 {
...
public function afficher_les_emails($droit_public,$droit_prive,$droit_affaires)
{
