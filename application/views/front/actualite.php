...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_link_base("css_front");?>actualite.css">
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">

	<title>A.G.D.Z - Actualite</title>
</head>
<body onload="init();">
				...
				<div class="demande"><h5>Actualités</h5></div>
					...
					<div class="row">
				 	...
				 	<h6 style="text-align: center">Infos Covid-19</h6>
				 		...
				 		<button class="info"><a href="https://www.who.int/fr"></a></button>
					          	...
					          	<div class="actuBas col-md-6">
					          		...
					          		<div class="row">
					          			<div class="actualite3 col-md-6">
					          				<form method="" action=""><input type="checkbox" name="">
					                       <a href="newletterDroitPena">Droit Pénal</a><br>
					                      &nbsp; <input type="checkbox" name="">
										<a href="newletterDroitPena">Droit Public</a></form>
										...
										<input type="checkbox" name="">
					                 	<a href="newletterDroitPena">Les Trois</a></form>
					          			</div>
					          		</div><br>
					          		<div class="row">
					          			<div class="actualite3 col-md-12">
...
<script src="<?php echo site_link_base("js_front");?>newspapers.js"></script>
