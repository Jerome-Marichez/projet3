...
<html lang="fr">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo site_link_base('css');?>styles.css">
		<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro%7COpen+Sans+Condensed:300%7CRaleway' rel='stylesheet' type='text/css'>
