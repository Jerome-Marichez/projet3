  ...
  <div class="row ">
      <div class="col-md-6 text-center">
        ...
        <div class="card-body">
          ...
          <h5 class="card-ligne1-rendezvous"> <i class="fa fa-calendar-check fa-2x" ></i>24/07/15 <i class="fa fa-clock fa-2x" style="padding-left: 50px"></i>9h30</div>
          <p class="card-ligne2-rendezvous">Cabinet</p>
            <p class="card-ligne2-rendezvous"><b>Léa DUPONT</b></p>
