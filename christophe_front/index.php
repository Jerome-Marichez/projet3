 ...
 <div class="but2">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="10000">
      <img src="images/actualite1.jpg" class="d-block w-100" alt="actualite1">
    </div>
    <div class="carousel-item" data-interval="2000">
      <img src="images/actualite2.jpg" class="d-block w-100" alt="actualite2">
    </div>
    <div class="carousel-item">
      <img src="images/actualite3.jpg" class="d-block w-100" alt="actualite3">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleInterval" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
	 ...
	 <br>
	 <div class="row">
	 	<div class="col-sm-4 col-md-4"><img src="images/imageDroitPublic.jpg"><div class="texte_centrer">DROIT PUBLIC</div></div>
	 	<div class="col-sm-4 col-md-4"><img src="images/imageDroitPenal.jpg"><div class="texte_centrer">DROIT PENAL</div></div>
	 	<div class="col-sm-4 col-md-4"><img src="images/imageDroitPrive.jpg"><div class="texte_centrer">DROIT PRIVE ET DES AFFAIRES</div></div>
	 </div><br>
	 <div class="row">
